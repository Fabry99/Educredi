...
} from "./chunk-FF4QV3GO.js";
import {
  dataTables_default
} from "./chunk-OF6FBGAP.js";
import {
  require_jquery
...
// node_modules/datatables.net-keytable-dt/js/keyTable.dataTables.mjs
...
var KeyTable = function(dt, opts) {
  if (!dataTables_default.versionCheck || !dataTables_default.versionCheck("1.10.8")) {
    throw "KeyTable requires DataTables 1.10.8 or newer";
  }
  this.c = $.extend(true, {}, dataTables_default.defaults.keyTable, KeyTable.defaults, opts);
  this.s = {
...
$.fn.DataTable.KeyTable = KeyTable;
dataTables_default.Api.register("cell.blur()", function() {
...
dataTables_default.Api.register("cell().focus()", function() {
...
dataTables_default.Api.register("keys.disable()", function() {
  return this.iterator("table", function(ctx) {
    if (ctx.keytable) {
...
dataTables_default.Api.register("keys.enable()", function(opts) {
  return this.iterator("table", function(ctx) {
    if (ctx.keytable) {
...
dataTables_default.Api.register("keys.enabled()", function(opts) {
...
dataTables_default.Api.register("keys.move()", function(dir) {
  return this.iterator("table", function(ctx) {
    if (ctx.keytable) {
...
$(document).on("preInit.dt.dtk", function(e, settings, json) {
  ...
  var defaults = dataTables_default.defaults.keys;
  if (init || defaults) {
...
// node_modules/datatables.net-keytable-dt/js/keyTable.dataTables.mjs
var keyTable_dataTables_default = dataTables_dataTables_default;
export {
  keyTable_dataTables_default as default
};
...
datatables.net-keytable-dt/js/keyTable.dataTables.mjs:
   ...
   *)
*/
//# sourceMappingURL=datatables__net-keytable-dt.js.map
